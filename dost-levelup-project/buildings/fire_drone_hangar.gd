...
class_name DroneHangar

var cooldown_timer = 0.0
var effect_interval = 25.0

func init_stats():
	max_hp = 80
	hp = max_hp
	fire_resistance = 0.7    # Takes full fire damage
	wind_resistance = 1.0   
...
func trigger_effect(delta):
	#for each adjacent plot every 25 seconds, increase their wind resistance by 0.01 (up to a max of 0.3)
...
func show_increase() -> void:
	...
	popup.show_text("All Res++", global_position + Vector2(jitter_x, -20))
